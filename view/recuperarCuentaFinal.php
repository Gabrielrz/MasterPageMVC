...
<form class="form-signin mx-auto col-12 p-3" action="index.php?seccion=recuperarCuentaFinal" method="post">
        ...
        <input type="passVerify" name="passVerify" class="form-control" placeholder="Tu contraseña " required>
